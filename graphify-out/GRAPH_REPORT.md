...
## Corpus Check
- 21 files · ~14,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 178 nodes · 198 edges · 18 communities (17 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d81d419`
...
10. `Drift Audit Registry - PanPan` - 5 edges
...
### Community 15 - "Drift Audit Registry - PanPan"
Cohesion: 0.22
Nodes (8): Cosmetic / Technical Debt, Critical (Breaks core functionality if deployed), Drift Audit Registry - PanPan, Eras, Findings, Moderate (Breaks auxiliary features), Responsibilities, Risk Priority

## Knowledge Gaps
- **90 isolated node(s):** `manifest_version`, `name`, `version`, `description`, `16` (+85 more)
